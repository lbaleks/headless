...
export default function CustomerDetail(){
  ...
  if(!c) return <AdminPage title="Customer"><div>Loading…</div></AdminPage>
  ...
  return (
    <AdminPage title={c.name||'Customer'}>
      ...
      <div className="admin-panel p-4 mt-4">
        ...
        {tab==='activity' && (
          <Timeline items={[
            {text:'Created customer',ts:NOW-1000*60*60*24*5,tone:'success'},
            {text:'Order #324 confirmed',ts:NOW-1000*60*60*24*2,tone:'info'},
            {text:'Invoice overdue',ts:NOW-1000*60*60*5,tone:'danger'},
          ]}/>
        )}
