...
echo "🛠 Installerer produktdetaljside + kvantum & enkel cart…"

# Sørg for mapper
mkdir -p app/product/[sku]
mkdir -p src/components

# StockBadge – enkel fargemerking basert på tall
cat > src/components/StockBadge.tsx <<'TS'
"use client";
...
# Produktdetaljside
cat > app/product/[sku]/page.tsx <<'TS'
"use client";
...
# (Valgfritt) Enkel /public/placeholder
mkdir -p public
if [ ! -f public/placeholder.svg ]; then
  cat > public/placeholder.svg <<'SVG'
<svg width="800" height="600" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
  <rect width="800" height="600" fill="#f2f2f2"/>
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#9ca3af" font-size="24" font-family="sans-serif">No image</text>
</svg>
SVG
fi

echo "✅ Ferdig installert. Kjør: pnpm dev (og åpne /product/<sku>)"
